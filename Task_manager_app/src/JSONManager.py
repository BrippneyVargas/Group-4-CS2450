...
class JSONManager(DatabaseManager):
    def __init__(self):
        ...
        self.TASKS_FILE = "./Task_manager_app/src/data/tasks.json"
    ...
    async def get_tasks(self):
        ...
        """
        return {"tasks": [task.__dict__ for task in self.tasks]} 
    ...
    async def add_task(self, task: Task): 
        ...
        new_task = Task(id=self.task_id_counter, title=task.title, description=task.description, priority=task.priority, tag=task.tag)
