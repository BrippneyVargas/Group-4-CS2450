...
class Styler:
    ...
    def refresh():
        ...
        Styler.config_object.read("config.ini")
    ...
    def apply_custom_theme(dark_mode: bool): #Change the two modes to a composition.
        ...
        if dark_mode: 
            ...
            .priority-medium {{ background-color: {priority_info["medium"]}; color: white; padding: 5px 10px; border-radius: 5px; text-align: center; }}
